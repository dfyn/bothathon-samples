...
/// @notice Dfyn's concentrated liquidity pool manager contract Structs.
...
/// @notice Dfyn's concentrated liquidity manager contract interface.
interface IConcentratedLiquidityPoolManager is IConcentratedLiquidityPoolManagerStruct, IDfynNFT {
